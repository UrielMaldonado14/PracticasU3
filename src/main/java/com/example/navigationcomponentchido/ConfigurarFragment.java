    ...
    public void onGesturePerformed(GestureOverlayView gestureOverlayView, Gesture gesture) {
        ...
        if (predictions.size() > 0 && predictions.get(0).score > 1.0) {
            ...
            if (action.equals("salir")) {
                Toast.makeText(getActivity(), "Telefono gesture", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://www.instagram.com/uriel_oso_maldonado/")); // Reemplaza "tu_usuario_aqui" con tu nombre de usuario en Instagram.
